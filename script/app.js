...
let lvl = document.querySelector('h1')
let styl = document.querySelector('.title')
...
function time() {
    if (i <= 99) {
       lvl.innerHTML = i ;
       i++
       lvl.style.color = `rgb(${randomColor(0,255)},${randomColor(0,255)},${randomColor(0,255)}) `
       setTimeout(() => {
        time()
       }, 50)
    }
    if (lvl.innerHTML == 99) {
    lvl.style = `font-size: 100px;  `
